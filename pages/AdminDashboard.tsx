      ...
      <div className="relative p-6 bg-prospera-accent/5 border border-prospera-accent/10 rounded-[2.5rem] overflow-hidden terminal-grid">
         ...
         <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="space-y-1">
               <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-prospera-accent animate-ping" /><h2 className="text-2xl font-black dark:text-white text-gray-900">Governance</h2></div>
               <p className="text-prospera-gray font-black uppercase tracking-[0.4em] text-[8px]">Real-Time Terminal Monitoring</p>
            </div>
            <div className="flex gap-3">
               <div className="px-4 py-2 bg-white dark:bg-prospera-dark rounded-xl border border-gray-100 dark:border-white/5 shadow-xl text-center"><p className="text-[8px] text-prospera-gray font-black uppercase mb-0.5">Health</p><p className="text-base font-black text-prospera-accent">98%</p></div>
               <div className="px-4 py-2 bg-white dark:bg-prospera-dark rounded-xl border border-gray-100 dark:border-white/5 shadow-xl text-center"><p className="text-[8px] text-prospera-gray font-black uppercase mb-0.5">Latency</p><p className="text-base font-black text-blue-400">12ms</p></div>
            </div>
         </div>
      </div>
